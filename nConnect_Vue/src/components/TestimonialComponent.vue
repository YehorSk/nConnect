        ...
        <div v-for="(review, index) in reviewStore.getReviews.data" :key="index" class="col-lg-4 col-md-6 mb-20">
          ...
          <div class="testimonial-item">
            ...
            <div class="person">
              <div class="media">
                <!-- Person Image -->
                <img loading="lazy" :src="'https://api.nconnect.mojawebka.eu/nConnect-Laravel/public/storage/' + review.image" alt="person-image"> <!-- Use the 'photo' property from the store -->
