                  ...
                  <template v-else v-for="lecture in lectureStore.getMainLectures" :key="lecture.id">
                    <li @click="showDetails(lecture)" class="schedule-details">
                      <div class="block">
                        ...
                        <!-- Speaker -->
                        <div class="speaker">
                          <img v-if="lecture.speaker_image !== null" :src="'https://api.nconnect.mojawebka.eu/nConnect-Laravel/public/storage/' + lecture.speaker_image" width="50px" height="50px" alt="speaker-thumb-one">
              ...
              <v-card-actions>
                <v-list-item class="w-200" v-if="show_lecture.is_lecture === 1">
                  <template v-slot:prepend>
                    <v-avatar color="grey-darken-3" :image="'https://api.nconnect.mojawebka.eu/nConnect-Laravelpublic/storage/' + show_lecture.speaker_image"></v-avatar>
                  </template>
